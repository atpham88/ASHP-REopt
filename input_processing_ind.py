        ...
        for building in building_types:
            for config in configs:
                ...
                if config == 'config1':
                    ...
                    #post1['ASHPSpaceHeater']['max_ton'] = 99999999
                    post1['ASHPSpaceHeater']['can_serve_cooling'] = False

                    # ASHP Water Heater:
                    post1['ASHPWaterHeater'] = {}
                    post1['ASHPWaterHeater']['max_ton'] = 99999999
                ...
                if config == 'config3':
                    ...
                    post3['ASHPSpaceHeater']['max_ton'] = 99999999

                    # ASHP Water Heater:
                    post3['ASHPWaterHeater'] = {}
                    post3['ASHPWaterHeater']['max_ton'] = 99999999
                ...
                if config == 'config4':
                    ...
                    # Electric Heater:
                    #post4['ElectricHeater'] = {}
                    #post4['ElectricHeater']['max_mmbtu_per_hour'] = 99999999
